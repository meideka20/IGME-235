...
function createLabelsAndButtons() {
    ...
    let startLabel2 = new PIXI.Text("Circle Blast!");
    ...
    startButton.on('pointerout', e => e.current.target.alpha = 1.0);
...
function gameLoop() {
    ...
    ship.y = clamp(newY, 0 + w2, sceneHeight - h2);
...
function end() {
    ...
    explosions.forEach(b => gameScene.removeChild(e));
    explosions = [];
